    ...
    <section className='w-[80%] min-h-lvh mx-auto flex flex-wrap justify-center gap-4 p-12'>
      ...
      <div className="w-full rounded-lg border-[2px] border-primary bg-secondary px-2 pb-5">
        ...
        <div className="flex flex-wrap justify-center gap-2">
          {frontend.map((front,index) => <span key={index} className='cr text-center rounded-lg bg-primary text-white py-2 px-4 hover:scale-110 transition-all duration-[.3s]'> {front} </span>)}
        </div>
      </div>
      ...
      <div className="w-full flex flex-wrap lg:flex-nowrap gap-4">
        <div className="w-full lg:w-1/2 rounded-lg border-[2px] border-primary bg-secondary px-2 pb-5">
          ...
          <div className="flex flex-wrap justify-center gap-2">
            {deployment.map((deployment,index) => <span key={index} className='cr text-center rounded-lg bg-primary text-white py-2 px-4 hover:scale-110 transition-all duration-[.3s]'> {deployment} </span>)}
          </div>
        </div>
      ...
      <div className="w-full rounded-lg border-[2px] border-primary bg-secondary px-2 pb-5">
        ...
        <div className="flex justify-center flex-wrap gap-2">
          {softSkills.map((skill,index) => <span key={index} className='cr text-center rounded-lg bg-primary text-white py-2 px-4 hover:scale-110 transition-all duration-[.3s]'> {skill} </span>)}
        </div>
      </div>
    </section>
  </>
